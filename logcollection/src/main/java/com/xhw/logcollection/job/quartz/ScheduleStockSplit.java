 ...
 * @Date 2018/3/30
 */
public class ScheduleStockSplit implements Job{

    @Override
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        int yxzt = TaskStatus.getYXZT(Constant.TASKID_STOCK_SPLIT_TASK);
        int sfzd = TaskStatus.getSFZD(Constant.TASKID_STOCK_SPLIT_TASK);
        if(sfzd == 1 && yxzt == 1){
